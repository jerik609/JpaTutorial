...
Hibernate: select t1_0.tweet_id,u1_0.id from tweet2 t1_0 left join userx u1_0 on u1_0.id=t1_0.userx_id where t1_0.tweet_id=?
Hibernate: select u1_0.id,t1_0.userx_id,t1_0.tweet_id from userx u1_0 left join tweet2 t1_0 on u1_0.id=t1_0.userx_id where u1_0.id=?
...
Hibernate: insert into tweet2 (userx_id, tweet_id) values (?, ?)
...
Hibernate: select t1_0.tweet_id,u1_0.id from tweet2 t1_0 left join userx u1_0 on u1_0.id=t1_0.userx_id where t1_0.tweet_id=?
Hibernate: select t1_0.userx_id,t1_0.tweet_id from tweet2 t1_0 where t1_0.userx_id=?
...
Hibernate: update tweet2 set userx_id=null where userx_id=?
Hibernate: delete from tweet2 where tweet_id=?
